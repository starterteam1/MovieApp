...
class SearchViewModel {
    ...
    var allMovies: [TMDBMovie] = [] // API에서 가져온 모든 영화
    var filteredMovies: [TMDBMovie] = [] // 필터링된 영화
    ...
    func searchMovies(query: String) {
        ...
        AF.request(url, method: .get, parameters: parameters).responseDecodable(of: TMDBMovieResponse.self) { [weak self] response in
